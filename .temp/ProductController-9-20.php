...
//	  }
			 ...
			 foreach($product->prices as $price){
				...
				// Price::create([
				  ...
				  $price->model = $request->input('model');
				  $price->upc = $request->input('upc');
				  $price->sku = $request->input('sku');
				  $price->alt_details = $request->input('alt_details');
				  $price->quantity = $request->input('quantity');
				 $product->prices()->save($price);
//]);
				 //FlashAlert()->success('Success!', 'The Product Price Was Successfully Added');
			 }
...
//						'photoinfo' => $request->input('photoinfo'),
//						'linkto' => $request->input('linkto'),
//						'use_main' => $request->input('use_main'),
//						'use_thumb' => $request->input('use_thumb'),
//						'use_gallery' => $request->input('use_gallery')
					]);
				}
			}
		}
...
//				$productFeature->useicon = $request->input('useicon');
