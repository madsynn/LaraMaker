    ...
    <div class="login-header login-caret">
        <div class="login-content">
            <a href="index.html" class="logo">
                <h1 align="center" style="color:#FFF;font-weight:bold;">{{lang('Admin Panel')}}</h1>
            </a>

            <p class="description">{{lang('Dear user, log in to access the admin area!')}}</p>
        </div>
    </div>
    ...
    <div class="login-form">
        <div class="login-content">
            ...
            <div class="login-bottom-links">
                <a href="{{url('admin/forgot')}}" class="link">{{lang('Forgot your password?')}}</a>
            </div>
        </div>
    </div>
</div>
