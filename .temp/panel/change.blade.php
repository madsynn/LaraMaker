...
<head>
    ...
    <title>iCMS - {{lang('Change Password')}}</title>
    ...
    <div class="login-header login-caret">
        <div class="login-content">
            <a href="index.html" class="logo">
                <h1 align="center" style="color:#FFF;font-weight:bold;">{{lang('Change Password')}}</h1>
            </a>
        </div>
    </div>
        ...
        <div class="login-content">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="reset_code" id="username"
                           placeholder="{{lang('Reset Code')}}"
                           autocomplete="off"/>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="password" class="form-control" name="cpassword" id="username"
